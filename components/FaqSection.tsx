...
const FAQ_DATA: FaqItem[] = [
  ...
  {
    id: 'faq-speed',
    question: 'Сколько времени занимает проверка рекламных кампаний?',
    answer:
      'Анализ загруженного файла выгрузки занимает от 30 секунд до 2 минут. Прямое сканирование через API Яндекс.Директ выполняется в фоновом режиме за 1–2 минуты, после чего система формирует готовый отчет с расчетом сэкономленного бюджета.',
  ...
  },
  {
    ...
    answer:
      'Директу выгодно увеличивать охват и расход бюджета рекламодателя, предлагая автотаргетинг и расширение ставок. Независимый алгоритм Cransys работает строго в интересах владельца бизнеса: выявляет скрытые сливы в РСЯ (мусорные мобильные приложения, сайты-кликеры), нецелевые информационные фразы на поиске и аномальные ставки на мобильных устройствах.',
  ...
  {
    id: 'faq-excel-format',
    question: 'Какие форматы файлов поддерживает сервис?',
    answer:
